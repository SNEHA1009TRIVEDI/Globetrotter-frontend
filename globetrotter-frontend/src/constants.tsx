export const API_BASE_URL = import.meta.env.REACT_APP_API_URL || 'http://localhost:3080';
export const AUTH_REGISTER = `${API_BASE_URL}/auth/register`;
export const AUTH_LOGIN = `${API_BASE_URL}/auth/login`;
export const FRONTEND_URL = import.meta.env.FRONTEND_URL || 'http://localhost:5173';
